...
class __TwigTemplate_d8da462398306dfc25008a615b3efc93 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<style>
    body{ background-color: rgb(126, 126, 183);display: flex;flex-wrap: wrap;}
    .card { border: solid 1px; margin-bottom: 20px !important;border-radius: 5px;width:30%; margin: auto;max-height: 200px;min-height: 200px;overflow: hidden; overflow: scroll;}
    .art { display:flex; margin:  auto;  width: 95%;justify-content: center; padding: 1%;}
    .example-wrapper { display:flex; margin:  auto;  width: 95%;justify-content: center; padding: 1%;}
...
<div class=\"example-wrapper\">
    ...
    <div class=\"art\">";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "texte", [], "any", false, false, false, 21), "html", null, true);
            echo "</div> 
</div>
    ";
        }
...
";
    ...
    {
        return array (  125 => 24,  116 => 21,  112 => 20,  105 => 18,  99 => 15,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    ...
    <div class=\"card\">
        <h3 class=\"art\">{{ article.titre }}</h3> 
    <div class=\"art\">{{ article.texte }}</div> 
</div>
    {% endfor %}

{% endblock %}", "articles/index.html.twig", "/Applications/MAMP/htdocs/blog-symfony/templates/articles/index.html.twig");
    }
}
